...
const BBusy = () => {
    ...
    const onloadConfirmed = async () => {
        const { data } = await axios.get(`/api/shudduchmatching/getBusy?boyid=${id}`);
    ...
    const onUpdateClick = async () => {
        await axios.post('/api/shudduchMatching/updateBusyInfo', {
            nameOfOtherSide,
            emailAddress,
            homePhone,
            cellPhone,
    ...
    return (
        ...
        <div className="pretty-table">
            <table className="table table-striped mt-4 table-bordered" style={{ background: 'white' }}>
                <thead>
                    <tr>
                        <th style={{ verticalAlign: 'middle', textAlign: 'center' }}>Name Of Other Side</th>
                        <th style={{ verticalAlign: 'middle', textAlign: 'center' }}>Parents Email Address</th>
                        <th style={{ verticalAlign: 'middle', textAlign: 'center' }}>Home Phone</th>
                        <th style={{ verticalAlign: 'middle', textAlign: 'center' }}>Cell Phone</th>
                        <th style={{ verticalAlign: 'middle', textAlign: 'center' }}>Comments after date {amountOfTimesWentOut}</th>
                        <th style={{ verticalAlign: 'middle', textAlign: 'center' }}>Said Yes</th>
                        <th style={{ verticalAlign: 'middle', textAlign: 'center' }}>Got A Yes</th>
                        <th style={{ verticalAlign: 'middle', textAlign: 'center' }}>Amount of Times Went Out</th>
