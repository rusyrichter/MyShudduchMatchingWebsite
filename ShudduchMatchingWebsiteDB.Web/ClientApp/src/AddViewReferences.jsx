...
const AddViewReferences = () => {
    ...
    useEffect(() => {
        const loadConfirmed = async () => {
            const { data } = await axios.get(`api/shudduchmatching/getReferencesbyBoyid?boyid=${id}`)
            setRefs(data);          
        };
    ...
    const onSaveClick = async () => {
        await axios.post('/api/shudduchmatching/addReference', {
            name,
            relation,
            phoneNumber,
            boyId: id
    ...
    const onDeleteClick = async (r) => {
        await axios.post('/api/shudduchmatching/deleteReference', {
            id: r.id
        });
        const { data } = await axios.get(`/api/shudduchmatching/getReferencesbyBoyid?boyid=${id}`);
        setRefs(data);
    ...
    const onUpdateClick = async () => {
        setEditModalOpen(false);
        await axios.post('/api/shudduchmatching/updateReference', {
            name,
            relation,
            phoneNumber,
            id: refId,
...
export default AddViewReferences;